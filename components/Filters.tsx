...
export function Filters({
  ...
  return (
    <aside className="rounded-2xl border border-white/10 bg-white/[0.03] p-5 shadow-xl shadow-black/10 backdrop-blur lg:sticky lg:top-24 lg:self-start">
        ...
        <div className="mt-3 flex flex-wrap gap-2">
          {categories.map((item) => (
            <button
              ...
              className={`rounded-md border px-3 py-2 text-sm font-bold transition duration-200 hover:border-cyan-300 hover:bg-cyan-300/10 ${
